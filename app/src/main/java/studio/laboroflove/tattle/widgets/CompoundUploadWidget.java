package studio.laboroflove.tattle.widgets;
...
import studio.laboroflove.tattle.LandingActivity;
...
public class CompoundUploadWidget extends FrameLayout {
    ...
    public void onPasteClipboardClicked(View v){
        boolean proceed = interactionListener.onPasteFromClipboardClicked();
        if(proceed){
