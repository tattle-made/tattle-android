...
import studio.laboroflove.tattle.utils.SimpleLocationUtil;
import studio.laboroflove.tattle.widgets.CompoundUploadWidget;
import studio.laboroflove.tattle.widgets.LoaderButton;
import studio.laboroflove.tattle.widgets.TagAdder;
...
public class LandingActivity extends AppCompatActivity implements  LandingActivityController.ControllerInterface{
    ...
    private boolean isSourceWhatsapp = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Submit Post");

        if (Intent.ACTION_SEND.equals(action) && type != null) {
            isSourceWhatsapp = true;
